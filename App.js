...
const SHOP_ITEMS = [
  {
    key: "cozy-poncho",
    name: "Poncho acogedor",
    price: 1200,
    image: require("./assets/shop/outfit-01.png"),
  },
  {
    key: "party-hat",
    name: "Gorro festivo",
    price: 850,
    image: require("./assets/shop/outfit-02.png"),
  },
  {
    key: "evening-cape",
    name: "Capa elegante",
    price: 1500,
    image: require("./assets/shop/outfit-03.png"),
  },
  {
    key: "rainbow-scarf",
    name: "Bufanda arcoíris",
    price: 990,
    image: require("./assets/shop/outfit-04.png"),
  },
];
...
export default function App() {
  ...
  const shopAnimation = useRef(new Animated.Value(0)).current;

  useEffect(() => {
    Animated.timing(shopAnimation, {
      toValue: isShopVisible ? 1 : 0,
      duration: 250,
      useNativeDriver: true,
    }).start();
  }, [isShopVisible, shopAnimation]);
  ...
  const shopTranslateX = shopAnimation.interpolate({
    inputRange: [0, 1],
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <Animated.View
        pointerEvents={isShopVisible ? "auto" : "none"}
        style={[
          styles.shopOverlay,
          {
            transform: [{ translateX: shopTranslateX }],
          },
        ]}
      >
        <View style={styles.shopContainer}>
          <View style={styles.shopHeader}>
            <Text style={styles.shopTitle}>Tienda de atuendos</Text>
            <Pressable
              accessibilityLabel="Cerrar tienda"
              accessibilityRole="button"
              onPress={() => setIsShopVisible(false)}
              style={styles.shopCloseButton}
            >
              <Text style={styles.shopCloseLabel}>Cerrar</Text>
            </Pressable>
          </View>
          <Text style={styles.shopSubtitle}>
            Desliza hacia la izquierda o toca “Cerrar” para volver al escenario.
          </Text>
          <ScrollView
          ...
          >
            {SHOP_ITEMS.map((item) => (
              <View key={item.key} style={styles.shopCard}>
                ...
                <View style={styles.shopPriceBadge}>
                  <Text style={styles.shopPriceText}>{item.price} oro</Text>
                </View>
                <Pressable accessibilityRole="button" style={styles.shopActionButton}>
                  <Text style={styles.shopActionLabel}>Obtener</Text>
                </Pressable>
              </View>
            ))}
          </ScrollView>
...
const styles = StyleSheet.create({
  ...
  shopOverlay: {
    ...
    left: 0,
    right: 0,
    backgroundColor: "rgba(20, 15, 7, 0.4)",
